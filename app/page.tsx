  ...
  return (
    <Canvas shadows camera={{ position: [-50, -25, 150], fov: 15 }}>
      <Suspense fallback={null}>
        ...
        <spotLight angle={0.4} penumbra={1} position={[20, 30, 2.5]} castShadow={true} shadow-bias={-0.00001} />
  ...
  return (
    <group>
      <RigidBody ref={ref} type="kinematicPosition" colliders="trimesh">
        <mesh castShadow={true} receiveShadow={true} rotation={[-Math.PI / 2, Math.PI, 0]}>
